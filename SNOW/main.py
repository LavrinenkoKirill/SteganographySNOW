...
sentences = count_sentences('text.txt')
empty_file_size = os.path.getsize('text.txt')
encode_bytes('text.txt', message)
...
decode_bytes('text.txt', 'result.txt')
...
# message = "SOS"
# encode_bytes('site.html', message)
# decode_bytes('site.html', 'result.txt')
